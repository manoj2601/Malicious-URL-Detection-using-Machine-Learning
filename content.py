...
class ContentFeatures:
    def __init__(self, url):
        ...
        self.valid_tags = self.__get_valid_html_tags()
        self.suspicious_functions = self.__get_suspicious_functions()
        self.host = self.__get_ip()


    def __get_valid_html_tags(self):
    ...
    def __get_suspicious_functions(self, url='https://gist.githubusercontent.com/eneyi/5c0b33129bcbfa366eb9fe79e96c1996/raw/96217aa7ea6698b17151f866f891ba701cbd7537/mal_script_functions.txt'):
